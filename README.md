...
- local Ollama extraction with Qwen3-4B;
...
Check that local Ollama is running and the configured model is installed:
...
NestJS API to the local Ollama `qwen3:4b` model. Ollama returns a fixed JSON
