...
var ssr_exports = /* @__PURE__ */ __exportAll$1({
	a: () => require_react,
	default: () => app_ssr_entry_default,
	handleSsr: () => handleSsr,
	i: () => useRouter,
	n: () => getLayoutSegmentContext,
	o: () => __toESM,
	r: () => usePathname,
	t: () => require_jsx_runtime
});
...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./layout-segment-context-B3_CX8Ut.mjs");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./error-boundary-CcKD-2-C.mjs");
		return {
			get "ErrorBoundary"() {
	...
	"a3133649d876": async () => {
		const m = await import("./InventoryApp-oLDfuAgV.mjs");
		return { get "default"() {
			return m["default"];
		} };
	}
...
//#endregion
export { ssr_exports as a, require_react as i, getLayoutSegmentContext as n, usePathname as o, require_jsx_runtime as r, useRouter as s, __toESM as t };
