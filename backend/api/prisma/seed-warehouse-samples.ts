...
const sampleItems = [
  ["SAMPLE-001", "Box", "STORAGE"],
  ["SAMPLE-002", "Wrap", "PACKING"],
  ["SAMPLE-003", "Gloves", "STORAGE"],
  ["SAMPLE-004", "Helmet", "STORAGE"],
  ["SAMPLE-005", "Bolt", "STORAGE"],
  ["SAMPLE-006", "Nut", "STORAGE"],
  ["SAMPLE-007", "Light", "STORAGE"],
  ["SAMPLE-008", "Cable", "STORAGE"],
  ["SAMPLE-009", "Cleaner", "STORAGE"],
  ["SAMPLE-010", "Cloth", "PACKING"],
  ["SAMPLE-011", "Wrench", "STORAGE"],
  ["SAMPLE-012", "Bin", "STORAGE"],
  ["SAMPLE-013", "Bearing", "STORAGE"],
  ["SAMPLE-014", "Tape", "PACKING"],
  ["SAMPLE-015", "Bottle", "RECEIVING"],
] as const;
